...
function mostrarCotizacionHTML(cotizacion) {
    ...
    const { PRICE, CHANGE24HOUR, LOWDAY, HIGHDAY, CHANGEPCT24HOUR, LASTUPDATE } = cotizacion
    ...
    ultimasHoras.innerHTML = `<p>Variación durante las últimas 24h: <span>${CHANGE24HOUR}</span>`;
